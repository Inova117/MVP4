  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-600">
        Extensible architecture supporting multiple data sources. Connect to
        external analytics platforms or use your own database. Each connector
        implements a standard interface for seamless integration.
      </p>
