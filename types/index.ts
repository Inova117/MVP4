...
export interface WidgetConfig {
  ...
  showLegend?: boolean
  stacked?: boolean
  /** KPI aggregation across the selected period. */
  aggregation?: 'sum' | 'avg' | 'last'
  /** Format the value compactly (1.2k, 3.4M). */
  compact?: boolean
  /** Lucide icon name shown on KPI cards. */
  icon?: string
  /** When set, this widget renders a categorical breakdown (id into the breakdown registry). */
  breakdown?: string
  /** Short unit label shown under KPI cards. */
  unit?: string
}
